...
function updateAndRender() {
    ...
    var yRotationMatrix = new Matrix3().setRotationY(90.0 * time.deltaTime * ydegrees);
    var xRotationMatrix = new Matrix3().setRotationX(90.0 * time.deltaTime * xdegrees);
    var rotationMatrix = xRotationMatrix.multiplyRightSide(yRotationMatrix);
